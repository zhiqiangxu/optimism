...
require (
	...
	github.com/ethstorage/da-server v0.0.0-20240429131756-431639da87c3
...
replace github.com/ethereum/go-ethereum v1.13.15 => github.com/blockchaindevsh/op-geth v0.0.0-20240523073441-fc5ea07db424
